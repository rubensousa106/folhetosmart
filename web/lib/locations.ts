// ⚠️ GERADO automaticamente a partir da app Android (FONTE ÚNICA) — NÃO editar à mão.
...
export const DISTRITOS_PT: string[] = [
  "Aveiro",
  "Beja",
  "Braga",
  "Bragança",
...
export const REGIAO_POR_DISTRITO: Record<string, string> = {
